...
public class CustomerDetails {
	...
	public CustomerDetails(Integer customerId, String customerName, Integer customerAge, String customerCountry,
			Double customerIncome, String customerEducation, String customerGender, String customerCaste,
			String customerProfession,  Long customerPhonenumber) {
		super();
	...
	public CustomerDetails(String customerName, Integer customerAge, String customerCountry, Double customerIncome,
