...
public class JwtTokenUtil {
	...
	private String secret = "Matrimony@2023"; // this secret is used to generate token,validate token
	...
	public String generateToken(String id, String user,String roleId) {
		...
		try {
			token = Jwts.builder().setId(id) // Consumer ID
					...
					.setIssuer("Matrimony").setIssuedAt(new Date(System.currentTimeMillis()))
